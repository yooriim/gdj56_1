...
<section class="enroll-container">
	    <div id="divOuter">
	        <div id="signupContainer">
	            ...
	            <hr>
	            <h3>아이디</h3>
	            <input type="text" id="userId" placeholder=" (필수) 아이디를 입력해주세요." required>
	            <button class="btns">중복확인</button>
	            <h3>비밀번호</h3>
	            <input type="password" id="userPw" placeholder=" (필수) 비밀번호를 입력해주세요." required>
	            <h3>비밀번호 확인</h3>
	            <input type="password" id="userPw" placeholder=" (필수) 비밀번호를 한번 더 입력해주세요." required>
	            <h3>이름</h3>
	            <input type="text" id="userName" placeholder=" (필수) 이름을 입력해주세요." required>
	            <h3>이메일</h3>
	            <input type="text" id="userEmail" placeholder=" (필수) 이메일 주소를 입력해주세요." required>
	            <button class="btns">이메일 인증</button>
	            <h3>이메일 인증</h3>
	            <input type="text" id="userEmailCert" placeholder=" (필수) 인증코드를 입력해주세요." required>
	            <h3>휴대폰 번호</h3>
	            <input type="text" id="userPhone" placeholder=" (필수) 휴대폰 번호를 입력해주세요. (-포함)" required>
	            <h3>생년월일</h3>
	            <input type="text" id="userPhone" placeholder=" (필수) 생년월일을 입력해주세요. (6자리)" required>
	            <br>            
	            <h3>방방 이용약관</h3>
	...
	이 외 서비스 이용과정에서 별도 동의를 통해 추가정보 수집이 있을 수 있습니다.
	            ...
	            <div id="ruleContainer">
	                <input type="checkbox" value="Y"> 이용약관에 동의합니다.
	                <br>
	                <input type="checkbox" value="Y"> 개인정보 수집 및 이용에 동의합니다.
	            </div>
	            <br>
